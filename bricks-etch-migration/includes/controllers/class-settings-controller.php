...
class B2E_Settings_Controller {
     ...
     */
    public function __construct(B2E_API_Client $api_client, Settings_Repository_Interface $settings_repository) {
...
\class_alias(__NAMESPACE__ . '\\B2E_Settings_Controller', 'B2E_Settings_Controller');
