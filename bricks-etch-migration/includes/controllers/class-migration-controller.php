...
class B2E_Migration_Controller {
    private $manager;
    private $api_client;
     ...
     */
    public function __construct(B2E_Migration_Manager $manager, B2E_API_Client $api_client) {
...
\class_alias(__NAMESPACE__ . '\\B2E_Migration_Controller', 'B2E_Migration_Controller');
