...
<section class="b2e-card b2e-card--source">
	<header class="b2e-card__header">
		<h2><?php esc_html_e( 'Bricks Site Migration Setup', 'bricks-etch-migration' ); ?></h2>
		<p><?php esc_html_e( 'Configure the connection to your Etch target site and start the migration process.', 'bricks-etch-migration' ); ?></p>
	</header>

	<form method="post" class="b2e-form" data-b2e-settings-form>
		<input type="hidden" name="nonce" value="<?php echo esc_attr( $nonce ); ?>" />
		<div class="b2e-field" data-b2e-field>
			<label for="b2e-target-url"><?php esc_html_e( 'Etch Site URL', 'bricks-etch-migration' ); ?></label>
		...
		<div class="b2e-field" data-b2e-field>
			<label for="b2e-api-key"><?php esc_html_e( 'Application Password', 'bricks-etch-migration' ); ?></label>
		...
		<div class="b2e-actions">
			<button type="submit" class="button button-primary"><?php esc_html_e( 'Save Connection Settings', 'bricks-etch-migration' ); ?></button>
		</div>
	</form>
	...
	<form method="post" class="b2e-inline-form" data-b2e-test-connection>
		...
		<button type="submit" class="button"><?php esc_html_e( 'Test Connection', 'bricks-etch-migration' ); ?></button>
	</form>

	<section class="b2e-card__section">
		<h3><?php esc_html_e( 'Migration Key', 'bricks-etch-migration' ); ?></h3>
		<form method="post" class="b2e-inline-form" data-b2e-generate-key>
			<input type="hidden" name="nonce" value="<?php echo esc_attr( $nonce ); ?>" />
			<div class="b2e-field" data-b2e-field>
				<label for="b2e-migration-key"><?php esc_html_e( 'Paste Migration Key from Etch', 'bricks-etch-migration' ); ?></label>
			...
			<div class="b2e-actions">
				<button type="submit" class="button"><?php esc_html_e( 'Generate New Key', 'bricks-etch-migration' ); ?></button>
				<button type="button" class="button" data-b2e-copy-button data-b2e-target="#b2e-migration-key" data-toast-success="<?php echo esc_attr__( 'Migration key copied.', 'bricks-etch-migration' ); ?>">
	...
	<section class="b2e-card__section">
		<h3><?php esc_html_e( 'Start Migration', 'bricks-etch-migration' ); ?></h3>
		<form method="post" class="b2e-form" data-b2e-migration-form>
			<input type="hidden" name="nonce" value="<?php echo esc_attr( $nonce ); ?>" />
			<div class="b2e-field" data-b2e-field>
				<label for="b2e-migration-token"><?php esc_html_e( 'Migration Token', 'bricks-etch-migration' ); ?></label>
				<input type="text" id="b2e-migration-token" name="migration_token" required />
			</div>
			<div class="b2e-field" data-b2e-field>
				<label for="b2e-migration-batch-size"><?php esc_html_e( 'Batch Size', 'bricks-etch-migration' ); ?></label>
			...
			<div class="b2e-actions">
				<button type="submit" class="button button-primary" data-b2e-start-migration>
					<?php esc_html_e( 'Start Migration', 'bricks-etch-migration' ); ?>
				</button>
				<button type="button" class="button" data-b2e-cancel-migration>
					<?php esc_html_e( 'Cancel', 'bricks-etch-migration' ); ?>
				</button>
			</div>
		</form>
	</section>
