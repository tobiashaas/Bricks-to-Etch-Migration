...
class B2E_CPT_Migrator {
    ...
    private function import_custom_post_type($cpt_data) {
        ...
        if (post_type_exists($post_type_name)) {
            ...
            $this->error_handler->log_warning('W003', array(
    ...
    public function validate_cpt_data($cpt_data) {
        ...
        if (!empty($cpt_data['name'])) {
            ...
            $reserved_names = array(
                ...
                'user_request', 'wp_block', 'action', 'author', 'order',
                'theme', 'fields', 'field_group', 'acf-field-group',
                'acf-field', 'meta-box', 'jet-engine-meta',
            );
