...
class B2E_CSS_Converter {
	 ...
	 */
	public function __construct( B2E_Error_Handler $error_handler, Style_Repository_Interface $style_repository ) {
...
\class_alias( __NAMESPACE__ . '\\B2E_CSS_Converter', 'B2E_CSS_Converter' );
