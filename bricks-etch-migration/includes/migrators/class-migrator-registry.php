...
class B2E_Migrator_Registry {
    ...
    public function get_all() {
        ...
        uasort($migrators, function(Migrator_Interface $a, Migrator_Interface $b) {
    ...
    public function get_supported() {
        return array_filter($this->get_all(), function(Migrator_Interface $migrator) {
...
\class_alias(__NAMESPACE__ . '\\B2E_Migrator_Registry', 'B2E_Migrator_Registry');
