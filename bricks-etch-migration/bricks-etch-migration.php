...
class Bricks_Etch_Migration {
    ...
    private function init_cors_manager() {
        ...
        if ($container->has('cors_manager')) {
            ...
            add_action('rest_api_init', function() use ($cors_manager) {
                remove_filter('rest_pre_serve_request', 'rest_send_cors_headers');
                add_filter('rest_pre_serve_request', function($value) use ($cors_manager) {
            ...
            add_action('rest_api_init', function() use ($cors_manager) {
                add_filter('rest_pre_dispatch', function($result, $server, $request) use ($cors_manager) {
