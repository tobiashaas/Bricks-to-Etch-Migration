...
class EFS_Migration_Manager {
	...
	public function __construct( EFS_Migration_Service $migration_service = null, Migration_Repository_Interface $migration_repository = null ) {
		...
		$cpt_migrator     = new EFS_CPT_Migrator( $error_handler );
		$acf_migrator     = new EFS_ACF_Field_Groups_Migrator( $error_handler );
		$metabox_migrator = new EFS_MetaBox_Migrator( $error_handler );
